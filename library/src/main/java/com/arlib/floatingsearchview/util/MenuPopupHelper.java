...
public class MenuPopupHelper implements AdapterView.OnItemClickListener, View.OnKeyListener,
    ...
    private MenuPopupHelper(Context context, MenuBuilder menu, View anchorView,
    ...
    private class MenuAdapter extends BaseAdapter {
        ...
        public int getCount() {
            @SuppressLint("RestrictedApi") ArrayList<MenuItemImpl> items = mOverflowOnly ?
        ...
        void findExpandedIndex() {
            @SuppressLint("RestrictedApi") final MenuItemImpl expandedItem = mMenu.getExpandedItem();
            if (expandedItem != null) {
                @SuppressLint("RestrictedApi") final ArrayList<MenuItemImpl> items = mMenu.getNonActionItems();
