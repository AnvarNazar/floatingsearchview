...
public class FloatingSearchView extends FrameLayout {
    ...
    private void setupQueryBar() {
        ...
        mSearchInput.setOnFocusChangeListener((View v, boolean hasFocus) -> {
        ...
        mLeftAction.setOnClickListener((View v) -> {
