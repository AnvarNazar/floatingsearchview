...
public class SlidingSearchResultsExampleFragment extends BaseExampleFragment implements SearchResultsListAdapter.OnItemClickListener {
    ...
    private void setupFloatingSearch() {
        mSearchView.setOnQueryChangeListener((String oldQuery, String newQuery) -> {
            ...
            if (!oldQuery.equals("") && newQuery.equals("")) {
                ...
                DataHelper.findSuggestions(getActivity(), newQuery, 5,
                        FIND_SUGGESTION_SIMULATED_DELAY, (List<ColorSuggestion> results) -> {
        ...
        mSearchView.setOnSearchListener(new FloatingSearchView.OnSearchListener() {
            ...
            public void onSuggestionClicked(final SearchSuggestion searchSuggestion) {
                ...
                DataHelper.findColors(getActivity(), colorSuggestion.getBody(),
                        results -> mSearchResultsAdapter.swapData(results));
        ...
        mSearchView.setOnMenuItemClickListener((MenuItem item) -> {
         ...
         * items in the list.
         */
        mSearchView.setOnBindSuggestionCallback((View suggestionView, ImageView leftIcon, TextView textView, SearchSuggestion item, int itemPosition) -> {
        ...
        //search results list
        mSearchView.setOnSuggestionsListHeightChanged((float newHeight) -> mSearchResultsList.setTranslationY(newHeight));
